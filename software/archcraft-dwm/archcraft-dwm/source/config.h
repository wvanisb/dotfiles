...
static const char *termcmd[]  			= { "~/.config/dwm/bin/dwmterm.sh", NULL };
static const char *floatterm[]  		= { "~/.config/dwm/bin/dwmterm.sh", "-f", NULL };
static const char *fmcmd[]    			= { "~/.config/dwm/bin/dwmapps.sh", "-f", NULL };
static const char *editcmd[]  			= { "~/.config/dwm/bin/dwmapps.sh", "-e", NULL };
static const char *webcmd[]  			= { "~/.config/dwm/bin/dwmapps.sh", "-w", NULL };

/* Rofi Menus */
static const char *rofi_cmd[] 			= { "~/.config/dwm/rofi/bin/launcher", NULL };
static const char *rofi_rootcmd[] 		= { "~/.config/dwm/rofi/bin/asroot", NULL };
static const char *rofi_layoutcmd[] 	= { "~/.config/dwm/rofi/bin/layouts", NULL };
static const char *rofi_mpdcmd[] 		= { "~/.config/dwm/rofi/bin/mpd", NULL };
static const char *rofi_nmcmd[]    		= { "~/.config/dwm/rofi/bin/network_menu", NULL };
static const char *rofi_powercmd[]  	= { "~/.config/dwm/rofi/bin/powermenu", NULL };
static const char *rofi_shotcmd[]  		= { "~/.config/dwm/rofi/bin/screenshot", NULL };
static const char *rofi_wincmd[]  		= { "~/.config/dwm/rofi/bin/windows", NULL };

/* Misc */
static const char *cpickcmd[]  			= { "color-gpick", NULL };
static const char *lockcmd[]  			= { "betterlockscreen", "--lock", NULL };
static const char *layoutswitcher[]  	= { "~/.config/dwm/bin/layoutmenu.sh", NULL };
